...
searchButton.addEventListener('click', async () => {
  ...
  let listaDeFilmes: any = await procurarFilme(query); // Utilizei o "listaDeFilmes: any" temporariamente para o for da linha 40 funcionar. Após teste, tentar uma solução sem usar tipo any.
